...
// Datetime in your Klaviyo account's timezone
...
const COUPON_CODE = "DRW-XH4J-SAT01";
...
<p><strong>Weekend Energy</strong></p>
...
<div style="border: 1px solid #e5e5e5; border-radius: 10px; padding: 14px 16px; margin: 14px 0 18px; background: #fafafa;">
  ...
  <div style="font-size: 13px; color: #444; margin-top: 6px;">
    Apply at checkout. Not posted anywhere else.
  </div>
</div>
...
1 unit is already $125 on the site (was $200). Your code <strong>${COUPON_CODE}</strong> takes it further. First-time customers only for the single unit deal.<br>
2 units drop to $199 total, which works out to $99.50 each. That one is open to everyone.<br><br>
Every order comes with 4 things included automatically:<br>
...
Use code <strong>${COUPON_CODE}</strong> at checkout.<br>
